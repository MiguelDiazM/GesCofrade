describe('Inventario', () => {
  ...
  it("Editar elemento", () => {
    ...
    cy.get('.form-editar > #elemento').type("Elemento Prueba Cypress MODIFICADO")

    cy.get('.form-editar > #descripcion').type("Elemento Prueba Cypress MODIFICADO")
    cy.get('.form-editar > [type="submit"]').click();
  })

  it("borrar elemento", () => {

    cy.get(':nth-child(10) > :nth-child(4) > #formulario-borrar > .btn-borrar').click();
